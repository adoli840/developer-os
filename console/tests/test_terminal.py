...
class TerminalRunnerTests(unittest.TestCase):
    ...
    def test_interactive_terminal_assets_use_xterm_and_websocket_pty(self) -> None:
        ...
        self.assertIn('/terminal.css?v=5', page)
        self.assertIn('/terminal.js?v=4', page)
        self.assertIn('id="terminal-viewport"', page)
        self.assertIn('id="copy-button"', page)
        self.assertIn('id="paste-button"', page)
        ...
        self.assertIn("attachCustomKeyEventHandler", javascript)
        self.assertIn("navigator.clipboard.writeText", javascript)
        self.assertIn("navigator.clipboard.readText", javascript)
        self.assertIn("state.terminal.paste(text)", javascript)
