...
DeveloperOS does not install a Windows Scheduled Task. Report Home repository
state explicitly when a fresh comparison is needed:
...
be run from the Office computer after its real workspace layout is available.
